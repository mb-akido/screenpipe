...
const INTEGRATION_ICONS: Record<string, React.ReactNode> = {
    ...
    gmail: (
      <svg viewBox="0 0 999.517 749.831" className="w-5 h-5" aria-hidden>
        <path fill="#4285F4" d="M68.149 749.831h159.014V363.654L0 193.282v488.4c0 37.709 30.553 68.149 68.149 68.149" />
        <path fill="#34A853" d="M772.354 749.831h159.014c37.709 0 68.149-30.553 68.149-68.149v-488.4L772.354 363.654" />
        <path fill="#FBBC04" d="M772.354 68.149v295.505l227.163-170.372V102.223c0-84.338-96.323-132.412-163.743-81.762" />
        <path fill="#EA4335" d="M227.163 363.654V68.149L499.758 272.6 772.354 68.149v295.505L499.758 568.105" />
        <path fill="#C5221F" d="M0 102.223v91.059l227.163 170.372V68.149L163.743 20.46C96.209-30.19 0 17.884 0 102.223" />
      </svg>
    ),
    discord: (
