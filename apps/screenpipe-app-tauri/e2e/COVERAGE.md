...
- Weighted coverage points: 159.0
...
| --- | --- | --- | --- | --- | --- | --- |
| windows | 57 | 192 | 154.0 | 15 | 61 | 92% |
| macos | 63 | 171 | 131.6 | 17 | 63 | 89% |
| linux | 48 | 155 | 125.3 | 13 | 58 | 86% |
...
| chat-ai | 14 specs / 23 tests / 15.3 pts | 17 specs / 27 tests / 16.7 pts | 13 specs / 22 tests / 14.8 pts |
...
| os-integration | 5 specs / 17 tests / 15.8 pts | 5 specs / 4 tests / 1.6 pts | - |
...
| real-ui-e2e | 36 specs / 112 tests / 89.8 pts | 37 specs / 99 tests / 79.3 pts | 32 specs / 92 tests / 76.7 pts |
...
| Chat window, composer, and streaming state | chat-ai | covered (strong; chat-sidebar-groups, chat-newchat-fresh) | covered (strong; chat-sidebar-groups, chat-newchat-fresh) | covered (strong; chat-sidebar-groups, chat-newchat-fresh) |
...
| chat-automation-card-duplicate.spec.ts | windows, macos, linux | chat-ai, real-ui-e2e | chat, chat-sidebar-dedupe | high | strong | real-user-flow | 1 | Clicks each home automation card and asserts exactly one conversation file is created per card click, preventing duplicate sidebar rows. |
...
| chat-newchat-fresh.spec.ts | windows, macos, linux | chat-ai, real-ui-e2e | chat, chat-sidebar-dedupe | medium | strong | synthetic | 2 | Cmd/Ctrl+N opens a fresh blank chat instead of hopping into the active non-empty chat, then reuses that blank chat on repeated presses. |
...
| owned-browser-auth-cookie-block.spec.ts | windows, macos | real-ui-e2e, os-integration | owned-browser, chat | high | partial | synthetic | 1 | Emits a native missing-auth-cookie block for LinkedIn and asserts the browser sidebar shows the actionable missing-login card. |
