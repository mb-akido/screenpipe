...
| --- | --- | --- | --- | --- | --- | --- |
| windows | 50 | 183 | 147.3 | 15 | 55 | 92% |
| macos | 56 | 162 | 124.8 | 17 | 57 | 89% |
| linux | 43 | 148 | 119.7 | 13 | 52 | 86% |
...
| zz-enterprise-license-prompt.spec.ts | windows, macos, linux | settings, billing, real-ui-e2e | enterprise-license-prompt, billing-gate | high | strong | real-user-flow | 1 | Enterprise activation gate surfaces invalid-key and seat-limit failures, then allows a successful retry after policy seats recover without requiring a reload. |
