...
- Weighted coverage points: 165.8
...
| os-integration | 5 specs / 22 tests / 19.3 pts | 5 specs / 9 tests / 5.1 pts | 1 specs / 6 tests / 4.2 pts |
...
| tauri-command | 9 specs / 23 tests / 14.5 pts | 10 specs / 25 tests / 15.0 pts | 9 specs / 23 tests / 14.5 pts |
...
| chat-subagent-async-completion.spec.ts | windows, macos, linux | chat-ai, real-ui-e2e | chat, chat-streaming, async-subagents | high | strong | synthetic | 1 | A settled assistant turn must accept a later async subagent completion as a distinct visible assistant message without another user prompt. |
