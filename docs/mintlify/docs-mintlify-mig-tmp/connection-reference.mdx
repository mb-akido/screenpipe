...
| --- | --- |
| communication | Gmail, Slack, Discord, Email (SMTP), Outlook, Telegram, WhatsApp, Microsoft Teams, Zoom |
...
| `gmail:work` and `gmail:personal` | separate Gmail inboxes |
...
curl "http://localhost:3030/connections/gmail/proxy/users/me/messages?maxResults=1"
...
| email search and sending | Gmail, Outlook |
